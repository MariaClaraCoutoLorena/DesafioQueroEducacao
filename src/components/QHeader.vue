...
<template>
  <section class="h-20 bg-white lg:flex items-center justify-between hidden">
    <QRow class="flex items-center justify-between">
      <template #sidebar>
  ...
  <section class="flex lg:hidden h-20 bg-white">
    <QRow class="flex items-center">
